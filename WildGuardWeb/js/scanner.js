...
// Wildlife database for mock Edge AI classifications
export const MOCK_WILDLIFE = [
    { name: "Bengal Tiger", scientific: "Panthera tigris tigris", category: "Rare / Endangered", baseConf: 94.2, anomaly: true, type: "tiger" },
    { name: "Indian Elephant", scientific: "Elephas maximus indicus", category: "Endangered", baseConf: 91.5, anomaly: false, type: "elephant" },
    { name: "Common Leopard", scientific: "Panthera pardus", category: "Vulnerable", baseConf: 89.8, anomaly: true, type: "leopard" },
    { name: "Indian Peafowl", scientific: "Pavo cristatus", category: "Normal / Protected", baseConf: 97.4, anomaly: false, type: "peacock" },
    { name: "Sambar Deer", scientific: "Rusa unicolor", category: "Normal", baseConf: 95.1, anomaly: false, type: "deer" }
];
...
export async function logScanDetection(wildlife, metrics) {
    ...
    const detection = {
        species: wildlife.name,
        scientific: wildlife.scientific,
        category: wildlife.category,
        confidence: confidence,
        status: wildlife.anomaly ? "alert" : "normal",
...
export function renderResultCards(detection, metrics, resultsDiv, metricsDiv) {
    ...
    resultsDiv.innerHTML = `
        <div class="results-header">
            <span class="title">${detection.status === 'alert' ? '🚨 ' + t('anomaly_detected') : '✅ ' + detection.species}</span>
        ...
        <div class="species-details-grid">
            ...
            <div class="detail-block">
                ...
                <span class="val" style="color: ${detection.status === 'alert' ? 'var(--alert)' : 'var(--accent)'}">${detection.status.toUpperCase()}</span>
            </div>
        </div>
    `;
